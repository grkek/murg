  ...
  module Macros
    module Button
      macro build_callbacks
        ...
        build_callback(%fresh{"getLabel"}, "getLabel", 0, get_label)
        build_callback(%fresh{"setLabel"}, "setLabel", 1, set_label)
        build_callback(%fresh{"getHasFrame"}, "getHasFrame", 0, get_has_frame)
        build_callback(%fresh{"setHasFrame"}, "setHasFrame", 1, set_has_frame)
        build_callback(%fresh{"getIconName"}, "getIconName", 0, get_icon_name)
        build_callback(%fresh{"setIconName"}, "setIconName", 1, set_icon_name)
        build_callback(%fresh{"getUseUnderline"}, "getUseUnderline", 0, get_use_underline)
        build_callback(%fresh{"setUseUnderline"}, "setUseUnderline", 1, set_use_underline)
